  ...
  const convertToWord = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `${files.length} PDF file(s) converted to Word successfully.`,
      });
    } catch (error) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <div className="inline-flex p-3 bg-gradient-to-r from-blue-500 to-green-500 rounded-full mb-4">
